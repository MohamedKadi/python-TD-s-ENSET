...
def trouver_solution(commande, entrepots):
    ...
    for nom_entrepot , infos in sorted_entrepots:
        ...
        for produit, qte in list(commande.items()):
            ...
            dispo = infos['stock'].get(produit, 0) # 0 for default value
...
# --- Run the function ---
plan, cout_total = trouver_solution(commande, entrepots)

# --- Display results ---
print("\n=== PLAN D'APPROVISIONNEMENT ===")
for entrepot, produits in plan.items():
